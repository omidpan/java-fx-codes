...
public class CurveDemo extends Application {
  ...
  public void start(Stage primaryStage) {
    ...
    //You can comment out following 2 lines to have QuadCurve with default fill and stroke
    // or Change the Fill color
    quadCurve.setFill(Color.WHITE);
    quadCurve.setStroke(Color.BLACK);

    pane.getChildren().addAll(quadCurve,
            new Circle(40, 20, 6),
    ...
    //You can comment out following 2 lines to have CubeCurve with default or Change the Fill color
