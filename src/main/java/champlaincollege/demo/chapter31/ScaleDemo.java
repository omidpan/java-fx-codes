...
public class ScaleDemo extends Application {
  ...
  public void start(Stage primaryStage) {
    ...
    /**
     * Since |sin(x)| <= 1, the y-coordinates are too small. To see the sine curve,
     * the program scales the y-coordinates up by 50 times (line 48) and shrinks the x-coordinates
     * by half (line 47).
     * Note scaling also causes the stroke width to change. To compensate it, the stroke width is
     * purposely set to 1.0 / 25 (line 49)
     */
