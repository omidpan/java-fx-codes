...
public class ContextMenuDemo extends Application {   
  ...
  public void start(Stage primaryStage) {   
    ...
    MenuItem menuItemNew = new MenuItem("New",
      new ImageView(Utility.getResource("new.png",ContextMenuDemo.class)));
    MenuItem menuItemOpen = new MenuItem("Open",
      new ImageView(Utility.getResource("open.png",ContextMenuDemo.class)));
    MenuItem menuItemPrint = new MenuItem("Print",
      new ImageView(Utility.getResource("print.png",ContextMenuDemo.class)));
