...
public class ShowArc extends Application {
  ...
  public void start(Stage primaryStage) {   
    ...
    Arc arc2 = new Arc(80, 80, 45, 90,  30+90, +35);
    /**
     * centerX, centerY → The center of the arc (here: (100,100)).
     *
     * radiusX, radiusY → The horizontal and vertical radius (here: 80,80).
     *
     * startAngle → Where the arc starts, in degrees (here: 30 + 90).
     * 30 + 90 is just an expression that evaluates to 120°.
     *
     * In JavaFX, angles are measured in degrees, starting at the 3 o’clock position (0°) and increasing clockwise.
     *
     * length → Angular extent of the arc (here: 35°)
     */
