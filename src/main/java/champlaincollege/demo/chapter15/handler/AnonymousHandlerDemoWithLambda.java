...
public class AnonymousHandlerDemoWithLambda extends Application {
  ...
  public void start(Stage primaryStage) {
    ...
    // Create and register the handler
      ...
      // Override the handle method
      btDown.setOnAction(e -> text.setY(text.getY() < pane.getHeight() ?
      ...
      // Override the handle method
      btRight.setOnAction(e -> text.setX(text.getX() < pane.getWidth() - 100?
